...
Material for the Programming with Python Hy-Tech Camp. Students can access the challenges and examples at https://bit.ly/PyChallenges.
...
The lecture should be interactive, and the students should be engaged.
...
| Kahoot | 10m |
| Break | 10m |
| Turtle Follow-Along | 30m |
| Turtle Challenges | 70m |